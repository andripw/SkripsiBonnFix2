...
//            CatastropheArea area = null;
//            LinkedList<Position> src = determineway(area);
            Position src = getInitialLocation(catastropheAreas[toArea]);
            if (!ref.add(0.0, src)) {
...
//            src = group.positionAt(t).add(getInitialLocation(area));
