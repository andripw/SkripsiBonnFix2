    ...
    public LinkedList<Position> determineMovementCycle(CatastropheArea area, CatastropheNode node) {
        ...
        switch (area.type) {
            case 0://orang pintar              
                ...
                break;
            case 1://orang biasa		 
                //patients waiting for treatment area, therefore specific cycle             
                do {
                    if (node.type == 0) { //transport node
                        if (movePhase == 0) {
                            //random movement to receive injured
                ...
                break;
            case 2://node nakal		
                //casualties clearing station, therefore specific cycle             
                do {
                    if (node.type == 0) { //transport node
                        if (movePhase == 0) {
                            //random movement to receive injured
